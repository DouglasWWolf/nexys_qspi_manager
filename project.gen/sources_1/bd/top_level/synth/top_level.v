...
module genx_simulator_imp_11PH10O
   (clk,
    qspi_bank_csn,
    qspi_host_csn,
    qspi_miso,
  ...
  input qspi_bank_csn;
  input qspi_host_csn;
  output [3:0]qspi_miso;
  input [3:0]qspi_mosi;
  input qspi_sck;
  input resetn;

  wire [3:0]genx_qspi_sim_miso;
  wire [31:0]gxsim_qspi_address;
  wire [1:0]gxsim_qspi_chip_select;
  wire [511:0]gxsim_qspi_handler_0_rdata;
  wire [31:0]gxsim_qspi_handler_dbg_address;
  wire [1:0]gxsim_qspi_handler_dbg_cs_id;
  wire gxsim_qspi_handler_dbg_notify_read;
  wire gxsim_qspi_handler_dbg_notify_write;
  wire [7:0]gxsim_qspi_handler_dbg_opcode;
  wire [511:0]gxsim_qspi_handler_dbg_rdata;
  wire [9:0]gxsim_qspi_handler_dbg_sck_counts;
  wire [511:0]gxsim_qspi_handler_dbg_wdata;
  wire gxsim_qspi_notify_read;
  wire gxsim_qspi_notify_write;
  wire [7:0]gxsim_qspi_opcode;
  wire [9:0]gxsim_qspi_sck_counts;
  wire [511:0]gxsim_qspi_wdata;
  wire qspi_manager_bank_csn;
  wire qspi_manager_host_csn;
  wire [3:0]qspi_manager_mosi;
  wire qspi_manager_sck;
  wire source_100mhz_sys_clk;
  wire source_100mhz_sys_resetn;

  assign qspi_manager_bank_csn = qspi_bank_csn;
  assign qspi_manager_host_csn = qspi_host_csn;
  assign qspi_manager_mosi = qspi_mosi[3:0];
  assign qspi_manager_sck = qspi_sck;
  assign qspi_miso[3:0] = genx_qspi_sim_miso;
  assign source_100mhz_sys_clk = clk;
  assign source_100mhz_sys_resetn = resetn;
  top_level_gxsim_qspi_0_0 gxsim_qspi
       (.address(gxsim_qspi_address),
        .bank_csn(qspi_manager_bank_csn),
        .chip_select(gxsim_qspi_chip_select),
        .host_csn(qspi_manager_host_csn),
        .miso(genx_qspi_sim_miso),
        .mosi(qspi_manager_mosi),
        .notify_read(gxsim_qspi_notify_read),
        .notify_write(gxsim_qspi_notify_write),
        .opcode(gxsim_qspi_opcode),
        .rdata(gxsim_qspi_handler_0_rdata),
        .sck(qspi_manager_sck),
        .sck_counts(gxsim_qspi_sck_counts),
        .wdata(gxsim_qspi_wdata));
  top_level_gxsim_qspi_handler_0_0 gxsim_qspi_handler
       (.address(gxsim_qspi_address),
        .async_notify_read(gxsim_qspi_notify_read),
        .async_notify_write(gxsim_qspi_notify_write),
        .clk(source_100mhz_sys_clk),
        .cs_id(gxsim_qspi_chip_select),
        .dbg_address(gxsim_qspi_handler_dbg_address),
        .dbg_cs_id(gxsim_qspi_handler_dbg_cs_id),
        .dbg_notify_read(gxsim_qspi_handler_dbg_notify_read),
        .dbg_notify_write(gxsim_qspi_handler_dbg_notify_write),
        .dbg_opcode(gxsim_qspi_handler_dbg_opcode),
        .dbg_rdata(gxsim_qspi_handler_dbg_rdata),
        .dbg_sck_counts(gxsim_qspi_handler_dbg_sck_counts),
        .dbg_wdata(gxsim_qspi_handler_dbg_wdata),
        .opcode(gxsim_qspi_opcode),
        .rdata(gxsim_qspi_handler_0_rdata),
  ...
  top_level_system_ila_0_3 system_ila_0
       (.clk(source_100mhz_sys_clk),
        .probe0(qspi_manager_sck),
        .probe1(qspi_manager_mosi[0]),
        .probe2(genx_qspi_sim_miso[0]),
        .probe3(qspi_manager_host_csn),
        .probe4(qspi_manager_bank_csn));
  top_level_system_ila_2_0 system_ila_2
       (.clk(source_100mhz_sys_clk),
        .probe0(gxsim_qspi_handler_dbg_notify_read),
        .probe1(gxsim_qspi_handler_dbg_notify_write),
        .probe2(gxsim_qspi_handler_dbg_opcode[0]),
        .probe3(gxsim_qspi_handler_dbg_sck_counts[0]),
        .probe4(gxsim_qspi_handler_dbg_address[0]),
        .probe5(gxsim_qspi_handler_dbg_cs_id[0]),
        .probe6(gxsim_qspi_handler_dbg_wdata[0]),
        .probe7(gxsim_qspi_handler_dbg_rdata[0]));
endmodule
...
module source_100mhz_imp_MSWE0P
  ...
  top_level_clk_wiz_0_0 clock_50mhz
       (.clk_in1(clk_in1_0_1),
...
module top_level
  ...
  wire [110:0]axi_qspi_iface_0_qspi_req_out;
  ...
  wire qspi_manager_host_csn;
  wire [3:0]qspi_manager_mosi;
  wire [67:0]qspi_manager_qspi_rsp_out;
  wire qspi_manager_sck;
  wire source_100mhz_sys_clk;
  ...
  top_level_axi_qspi_iface_0_0 axi_qspi_iface
       (.S_AXI_ARADDR({system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR}),
        ...
        .clk(source_100mhz_sys_clk),
        .qspi_req_out(axi_qspi_iface_0_qspi_req_out),
        .qspi_rsp_in(qspi_manager_qspi_rsp_out),
        .resetn(source_100mhz_sys_resetn));
  ...
  genx_simulator_imp_11PH10O genx_simulator
       (.clk(source_100mhz_sys_clk),
        .qspi_bank_csn(qspi_manager_bank_csn),
        .qspi_host_csn(qspi_manager_host_csn),
        .qspi_miso(genx_qspi_sim_miso),
        .qspi_mosi(qspi_manager_mosi),
        .qspi_sck(qspi_manager_sck),
        .resetn(source_100mhz_sys_resetn));
  top_level_qspi_manager_0_0 qspi_manager
       (.bank_csn(qspi_manager_bank_csn),
        .clk(source_100mhz_sys_clk),
        .host_csn(qspi_manager_host_csn),
        .miso(genx_qspi_sim_miso),
        .mosi(qspi_manager_mosi),
        .qspi_req_in(axi_qspi_iface_0_qspi_req_out),
        .qspi_rsp_out(qspi_manager_qspi_rsp_out),
        .resetn(source_100mhz_sys_resetn),
        .sck(qspi_manager_sck));
